...
**Anti-pattern:** "Looks better", "probably improved", "seems cleaner" → these eliminate autonomous loops because there's no decision function.
...
This isn't "removing humans." It reallocates human effort from execution to direction. Humans gain greater value by dedicating attention to irreducibly creative and strategic work.
